                  ...
                  <tbody>
                      ...
                      <td>
                        <div className="clearfix">
                          <div className="float-start">
                            <div className="fw-semibold">250</div>
                          </div>
                    ...
                    <tr className="align-middle">
                      ...
                      <td>
                        <div className="clearfix">
                          <div className="float-start">
                            <div className="fw-semibold">20</div>
                          </div>
                          <div className="float-end">
                            <small className="text-black-50 dark:text-gray-500">
                              {dict.dashboard.listing.usage_duration}
                        ...
                        <ProgressBar className="progress-thin" variant="danger" now={10} />
                      </td>
                    ...
                    <tr className="align-middle">
                      ...
                      <td>
                        <div className="clearfix">
                          <div className="float-start">
                            <div className="fw-semibold">1000</div>
                          </div>
                          <div className="float-end">
                            <small className="text-black-50 dark:text-gray-500">
                              {dict.dashboard.listing.usage_duration}
                        ...
                        <ProgressBar className="progress-thin" variant="success" now={98} />
                      </td>
